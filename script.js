/**
 * Key: . empty space, # wall
 * + static lava, = horizantal moving lava
 * | vertical moving lava, v dripping lava
 * @ starting position, o coin
 */
...
class Lava {
  constructor(pos, speed, reset) {
    this.pos = pos; this.speed = speed; this.reset = reset;
  }
...
const wobbleSpeed = 0.8, wobbleDist = 0.07;
